...
from workiq_routes import router as workiq_router
from workiq_process_bridge import router as workiq_bridge_router
load_dotenv()
...
def build_app() -> FastAPI:
    ...
    fastapi_app.include_router(workiq_router, prefix="/api", tags=["workiq"])
    fastapi_app.include_router(workiq_bridge_router, prefix="/api", tags=["workiq-bridge"])
